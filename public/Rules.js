...
var AboutText = [
  ...
  ['Paragraph', '<b>Nothing Private:</b> Anyone can view content on Redop, so posting anything private to you or someone else is against the rules.'],
  ['Paragraph', '<b>Permission Required:</b> When sending material with others you must have their permission.'],

  ['Paragraph', '<b>No Platform Manipulation (Spam):</b> Using Redop in a way which abuses the system or abuses other users will result in account termination.'],
