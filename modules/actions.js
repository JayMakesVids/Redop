    ...
    let actions = {
      ...
      sendchat: async function(button, post) {
        ...
        if (text.length > limit) {
          if (limit == 200) {
            showPopUp("That's Too Long", `Please keep your chats to under ${limit} characters. However, with Redop Premium, you can send chats with up to 400 characters!`, [["Premium", "var(--premiumColor)", function() { setPage("premium"); }], ["Okay", "var(--grayColor)"]]);
